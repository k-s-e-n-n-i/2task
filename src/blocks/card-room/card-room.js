$(function() {
  ...
  function handlePaginationClick(){
    let paginationBlock = $(this).closest('.card-room__image-block').find('.card-room__slider-pagination'),
      ...
      numFirstImg = parseInt($(this).closest('.card-room__image-block').find('.card-room__image:first').attr('id')),
    ...
    imageActive.closest('.card-room__image-block').find(`.card-room__image#${numImg}`).addClass('card-room__image_active');
  }
