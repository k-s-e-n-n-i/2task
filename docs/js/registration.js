...
$(function () {
    ...
    function handleSubmenuClick(e) {
        var itSubmenu = $(e.target).hasClass('header__submenu') || $(e.target).hasClass('header__submenu-li');
        if (itSubmenu) {
            e.stopPropagation();
        }
        else {
    ...
    function closeHeaderSubmenu(e) {
        var elementsSubmenu = $(e.target).closest('.header__menu-li_expand').length != 0;
        var openSubmenu = $('.header__submenu').hasClass('header__submenu_open');
