export class Model {
			...
			slider(thisSlider : any, dataSliderID : string) : object{ 
				//console.log('qq', this.sliderBlock(thisSlider, dataSliderID).querySelector('.rangeSlider_slider'));
		...
		export class View {
			range(thisSlider : any, dataSlider : object, model : any){
				...
				switch(dataSlider.type) {
					case 'interval' : {
						...
						//console.log(model.ind(thisSlider, dataSlider.idElement).style.left);	
			...
			type(thisSlider : any, dataSlider : object, model : any){
				switch(dataSlider.type) {
					case 'interval' : break;
			...
			scale(thisSlider : any, dataSlider : object, model : any){
			...
			orientation(thisSlider : any, dataSlider : object, model : any){
			...
			value(thisSlider : any, dataSlider : object, model : any){
		...
		export class Controller {
			...
			movie(thisSlider : any, dataSlider : object, range, e, lr : string, model : any, controller : any){
			...
			moveAt(thisSlider : any, dataSlider : object, startPos : number, lr : string, e, indWidth : number, model : any, controller : any){
				let pos, p;
				switch(controller.checkOrientation(dataSlider.orientation)) {
					case 'x': {
						if (dataSlider.step == 1){
							...
							controller.movingRange(thisSlider, dataSlider, lr, startPos, pos, indWidth, model, controller, model, controller);
						}else{//починить
					...
					case 'y': {
						pos = e.pageY - parseInt(model.slider(thisSlider, dataSlider.idElement).offset().top);
			...
			writeValueMin(thisSlider : any, val : number, model : any){
				model.valueMin(thisSlider).innerHTML = val;
			}
			writeValueMax(thisSlider : any, val : number, model : any){
			...
			clickSlider(thisSlider : any, dataSlider : object, model : any, controller : any){
			...
			checkRangeThisStep(thisSlider : any, dataSlider : object, pos : number, model : any, controller : any){
				let p = 0, masScale,
			...
			masScale(thisSlider : any, dataSlider : object, model : any){
			...
			configCheck(thisSlider : any, dataSlider : object, model : any){
			...
			configCheckStart(thisSlider : any, dataSlider : object, model : any){
				model.sliderBlock(thisSlider, dataSlider.idElement).querySelector('.rangeSlider_label__min').innerHTML = dataSlider.minStart;
				model.sliderBlock(thisSlider, dataSlider.idElement).querySelector('.rangeSlider_label__max').innerHTML = dataSlider.maxStart;
